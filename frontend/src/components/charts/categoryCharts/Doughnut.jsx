...
export default function ExpenseDoughnutChart({ lbls, cdata }) {
  ...
  useEffect(() => {
    ...
    const ctx = chart.ctx;
    // gredients bg colors
    const billsutilities = ctx.createLinearGradient(0, 0, 0, 300);
    billsutilities.addColorStop(0, "#A855F7");
    billsutilities.addColorStop(1, "#EC4899");
