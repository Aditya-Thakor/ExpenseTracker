...
export default function Popular() {
  ...
  return (
    <div className="h-full w-80 flex flex-col items-start gap-6 bg-gradient-to-br from-blue-500 to-cyan-500 border border-blue-500 scale-105     shadow-lg rounded-2xl p-px">
      <div className=" h-full w-full flex flex-col gap-6 rounded-2xl text-white bg-white/5  backdrop-blur-sm p-6">
        <div>
        ...
        <div>
          <p>
            <span className=" text-6xl">₹1999</span>
